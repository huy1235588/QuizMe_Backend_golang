...
import (
	...
	"github.com/huy/quizme-backend/internal/features/auth/repository"
...
func (s *authService) createAuthResponse(user *userdomain.User) (*dto.AuthResponse, error) {
	...
	tokenEntity := &authdomain.RefreshToken{
		UserID:    user.ID,
		Token:     refreshToken,
		JTI:       jti,
		IssuedAt:  time.Now(),
