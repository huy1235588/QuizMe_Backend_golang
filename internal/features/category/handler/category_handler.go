...
import (
	...
	"github.com/huy/quizme-backend/internal/features/category/service"
)
...
func (h *CategoryHandler) CreateCategory(c *gin.Context) {
	...
	// Convert to CreateCategoryRequest
	...
	category, err := h.categoryService.CreateCategory(createReq)
	if err != nil {
...
func (h *CategoryHandler) UpdateCategory(c *gin.Context) {
	...
	// Convert to UpdateCategoryRequest
	...
	category, err := h.categoryService.UpdateCategory(uint(id), updateReq)
	if err != nil {
		if errors.Is(err, service.ErrCategoryNotFound) {
			c.JSON(http.StatusNotFound, response.Error("Category not found"))
			return
